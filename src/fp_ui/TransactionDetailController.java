    ...
    public void printBill() {
        ...
        if (!transaction_id.equals("")) {
            try {
                ...
                document.open();
                document.add(new Paragraph("                     Apotik Elfata       "));
                document.add(new Paragraph("            Jl. Towua No.76B, Tatura Sel      "));
                document.add(new Paragraph("                  +624514010511       "));
                document.add(new Paragraph("===================================="));
                document.add(new Paragraph(Date));
                document.add(new Paragraph(Transaction_Id));
                document.add(new Paragraph("------------------------------------"));
                ...
                document.add(new Paragraph("-----------------------------------"));
                document.add(new Paragraph("Thanks for Coming"));
